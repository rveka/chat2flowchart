...
- **Automatic Flowchart Generation:** Convert your text into a flowchart with one click.
- **Export Options:** Save your flowcharts in various formats, such as PNG and PDF.
- **Customizable Templates:** Choose from a selection of templates to suit your needs.

## 📥 Download & Install
To download and install chat2flowchart, follow these steps:
...
5. **Follow Installation Instructions.** The installer will guide you through the steps. Accept the terms and conditions and choose your installation folder, then click “Install” to complete the process.

6. **Launch the Application.** Once the installation is finished, you can find chat2flowchart in your applications menu. Click to launch it and start creating flowcharts from your conversations.

## 📝 How to Use chat2flowchart
1. **Input Your Conversation.** Type or paste the text of your conversation in the provided text box.
2. **Generate Flowchart.** Click the "Generate" button. The application will automatically create a flowchart based on your input.
3. **Customize Your Flowchart.** Use the editing tools to modify the flowchart to your liking. You can add or remove elements as needed.
4. **Save Your Work.** When you're satisfied with your flowchart, click "Export" to save it in your preferred format.
